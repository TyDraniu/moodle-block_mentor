 ...
 */
$string['activecategories'] = 'Aktywne kategorie';
$string['activity'] = 'Aktywności';
$string['add_a_note'] = 'Dodaj notatkę';
$string['add_all'] = 'Add All';
$string['add_button'] = 'Dodaj';
$string['addedit'] = 'Dodawanie/edycja';
$string['all'] = 'All';
$string['all_courses'] = 'Wszystkie kursy';
$string['all_mentees'] = 'Wszyscy podwładni';
$string['all_mentors'] = 'Wszyscy przełożeni';
$string['all_students'] = 'Wszyscy studenci';
...
$string['allmentors'] = 'Wszyscy przełożeni';
...
$string['assign_mentor'] = 'Zarządzanie przełożonymi';
$string['assignedtomentor'] = 'Przypisany do przełożonego "{$a}"';
$string['assignedtomentornot'] = 'Nie przypisany do przełożonego "{$a}"';
...
$string['breadcrumb:activitiescompleted'] = 'Ukończone aktywności';
$string['breadcrumb:activitiesincompleted'] = 'Nieukończone aktywności';
$string['breadcrumb:draft'] = 'Activities Draft';
$string['breadcrumb:notattempted'] = 'Nie podjętych';
$string['breadcrumb:waitingforgrade'] = 'Oczekuje na ocenę';
...
$string['completionnotenabled'] = '<p>W tym kursie śledzenie ukończenia nie jest włączone.</p>';
$string['completionstatus'] = 'Status ukończenia';
$string['config'] = 'Ustawienia';
$string['confirm_delete'] = 'Czy chcesz usunąć rekord?';
...
$string['create_new_rule'] = 'Utwórz nową zasadę';
...
$string['fn_mentor:viewactivitylist'] = 'Wyświetl listę aktywności';
...
$string['manage_mentors'] = 'Zarządzanie';
$string['manage_notification'] = 'Zarządzanie powiadomieniami';
$string['managegroups'] = 'Zarządzanie grupami';
$string['managementorgroups'] = 'Mentor groups';
$string['managementormenteerelations'] = 'Relacje przełożony-podwładny';
$string['markinmanagerscoursecats'] = 'Mentor Manager - Kategorie kursów';
$string['markinmanagerscoursecatsdesc'] = 'Wybrane kategorie kursów będą przetwarzane przez blok Mentor Manager na stronie głównej Moodle i pulpicie nawigacyjnym.';
...
$string['mentees_without_mentor'] = 'Podwładni nie przypisani do pracodawcy';
$string['mentor'] = 'Przełożony';
...
$string['mentorroles'] = 'Przełożeni';
$string['mentors'] = 'Przełożeni';
...
$string['message_header'] = 'Progress Report from <strong>{$a->sitename}</strong> <br />Student: <strong>{$a->studentname}</strong> <br /><br /><hr />';
...
$string['nogrades'] = 'Brak ocen w tym kursie.';
$string['nomessagessent'] = 'No messages were sent.';
$string['not_found'] = 'Record not found';
$string['notattempted'] = 'Nie podjętych';
$string['notenrolledanycourse'] = 'Ten pracownik nie jest przypisany do żadnych szkoleń.';
$string['notes'] = 'Notatki';
$string['notification'] = 'Powiadomienie';
$string['notification_rules'] = 'Zasady powiadomień';
$string['notifications'] = 'Powiadomienia';
$string['notingroup'] = 'Not in group';
$string['numofcomplete'] = 'Liczba ukończonych aktywności';
$string['open'] = 'Open';
$string['open_progress_reports'] = 'Open Progress Reports';
$string['othersettings'] = 'Other settings';
$string['overview'] = 'Opis';
...
$string['pleaseselectagroup'] = 'Wybierz grupę';
$string['pleaseselectamentor'] = 'Wybierz przełożonego.';
...
$string['roles'] = 'Role';
$string['rule'] = 'Zasada';
$string['rule_name'] = 'Nazwa zasady ';
$string['run_now'] = 'Uruchom teraz';
$string['runallrules'] = 'Uruchom wszystkie zasady';
$string['search'] = 'Szukaj';
$string['select_student'] = 'Wybierz podwładnego: ';
$string['selectcategories'] = 'Wybierz kategorie';
...
$string['title:completed'] = 'Ukończone (Łącznie: {$a} aktywności)';
$string['title:incompleted'] = 'Nie ukończone (Łącznie: {$a} aktywności)';
$string['title:notattempted'] = 'Nie podjętych (Łącznie: {$a} aktywności)';
$string['title:saved'] = 'Szkic (Łącznie: {$a} aktywności)';
$string['title:waitingforgrade'] = 'Oczekuje na ocenę (Łącznie: {$a} aktywności)';
$string['toomanyusers'] = 'Zbyt wielu studentów.<br><a href="{$a}">Kliknij tutaj</a> aby wygenerować pełną listę.';
...
$string['waitingforgrade'] = 'Oczekuje na ocenę';
