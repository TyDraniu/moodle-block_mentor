 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class fn_user_add_filter_form extends moodleform {
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class fn_user_active_filter_form extends moodleform {
    ...
    public function definition() {
        ...
        $filtersession = $extraparams['filtertype'].'_user_filtering';
...
class fn_user_close_filter_form extends moodleform {
    public function definition() {
        $mform =& $this->_form;
        $mform->addElement('header', 'closehdr', '');
        // Add button.
        $mform->addElement('submit', 'close', get_string('close', 'block_fn_mentor'));
    }
}
